    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li>
                    <a href="icons.html">
                        <i class="zmdi zmdi-invert-colors"></i> <span>Pengembalian</span>
                    </a>
                </li>

                <li>
                    <a href="{{ url('data_buku') }}">
                        <i class="zmdi zmdi-format-list-bulleted"></i> <span>Daftar Buku</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ url('login_form') }}" target="_blank">
                ...
                <li><a href="javaScript:void();"><i class="fa fa-facebook-square"></i> <span>Facebook</span></a>
                </li>
                <li><a href="javaScript:void();"><i class="fa fa-twitter-square"></i>
